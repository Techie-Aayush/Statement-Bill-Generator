      ...
      <div className="my-6 flex-1 space-y-2 rounded-md bg-white p-4 shadow-sm sm:space-y-4 md:p-6">
        <div className="flex flex-col justify-between space-y-2 border-b border-gray-900/10 pb-4 md:flex-row md:items-center md:space-y-0">
          ...
          <div className="flex items-center space-x-2">
            ...
            <input
              required
              className="max-w-[130px] text-sm px-2 py-1 border border-gray-300 rounded-md"
              type="number"
              name="invoiceNumber"
              id="invoiceNumber"
              min="1"
        ...
        <h1 className="text-center text-lg font-bold">STATEMENT</h1>
          ...
          <div className="space-y-4 py-2">
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <input
                  className="w-full rounded-r-none bg-white border border-gray-300 shadow-sm px-2 py-1 text-sm text-gray-800"
                  type="number"
                  name="tax"
                  id="tax"
                  min="0.01"
                ...
                />
                <span className="rounded-r-md bg-gray-200 py-1 px-2 text-gray-500 shadow-sm">
                  %
                </span>
              </div>
            </div>
