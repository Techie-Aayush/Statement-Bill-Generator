...
const InvoiceModal = ({
  ...
  const saveAsPDFHandler = () => {
    ...
    toPng(dom)
      .then((dataUrl) => {
        const img = new Image();
        img.crossOrigin = 'anonymous'; // Corrected typo: 'annoymous' to 'anonymous'
        img.src = dataUrl;
        img.onload = () => {
          // Initialize the PDF.
          const pdf = new jsPDF({
          ...
          >
            <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all">
              ...
              <div className="mt-4 flex space-x-2 px-4 pb-6">
                <button
                  className="flex w-full items-center justify-center space-x-1 rounded-md border border-pink-500 py-2 text-sm text-pink-500 shadow-sm hover:bg-pink-500 hover:text-white"
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center space-x-1 rounded-md bg-pink-500 py-2 text-sm text-white shadow-sm hover:bg-pink-600"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
